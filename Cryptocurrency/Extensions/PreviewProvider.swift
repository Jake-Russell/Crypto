...
class DeveloperPreview {
    ...
    let stat3 = StatisticModel(title: "Portfolio Value", value: "£15.4K", percentageChange: -12.34)
    ...
    let coin = CoinModel(
           ...
           priceChangePercentage1HInCurrency: -0.800,
           priceChangePercentage24HInCurrency: -0.767,
           priceChangePercentage7DInCurrency: -3.995,
           priceChangePercentage14DInCurrency: -0.112,
           priceChangePercentage30DInCurrency: -9.83,
           priceChangePercentage1YInCurrency: -191.4,
           currentHoldings: 1.5,
           currentGBPInvestments: 1000)
}
